...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_3h7gbdr', 'template_zjxwbj5', form.current, {
                publicKey: 'PAj-B0ZdMlhhMgLuY',
            })
            .then(
                () => {
        ...
        <motion.div className='contact' ref={ref} variants={variants} initial='initial' whileInView="animate">
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>arkoprobha30@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
                    <span>Kandi, Murshidabad, West-Bengal, India</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Phone</h2>
                    <span>+91 9832813553</span>
                </motion.div>
            </motion.div>
            <div className="formContainer">

                <motion.div className="phoneContainer" initial={{ opacity: 1 }} whileInView={{ opacity: 0 }} transition={{ delay: 2, duration: 1 }}>
                    <motion.svg width='450px' height='450px' viewBox="0 0 24 24" variants={pathVariants}>
                        <motion.path
                ...
                <motion.form ref={form} onSubmit={sendEmail} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 3, duration: 1 }}>
                    ...
                    <input type="mail" required placeholder='Mail' name='email' />
